...
- (void)viewDidLoad
{
    ...
    _songThumbsUps = [[NSMutableArray alloc] initWithArray: @[@"4", @"2", @"12"]];
    
    _songThumbsDowns = [[NSMutableArray alloc] initWithArray: @[@"2", @"7", @"1"]];
...
- (void)thumbsUp:(int)songIndex {
    NSString *currentValue = [_songThumbsUps objectAtIndex:songIndex];
    int newValue = [currentValue intValue] + 1;
    [_songThumbsUps  replaceObjectAtIndex:songIndex withObject:[[NSNumber numberWithInt:newValue] stringValue]];
}

- (void)thumbsDown:(int)songIndex {
    NSString *currentValue = [_songThumbsDowns objectAtIndex:songIndex];
    int newValue = [currentValue intValue] + 1;
    [_songThumbsDowns replaceObjectAtIndex:songIndex withObject:[[NSNumber numberWithInt:newValue] stringValue]];
}
